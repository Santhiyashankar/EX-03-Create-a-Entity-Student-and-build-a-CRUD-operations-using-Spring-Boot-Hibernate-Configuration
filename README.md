...
```
### Output
<img width="1600" height="674" alt="image" src="https://github.com/user-attachments/assets/b081941b-ca7a-4024-b39c-f90754cfcf6c" />
<img width="1429" height="675" alt="image" src="https://github.com/user-attachments/assets/b832d77e-e84e-4378-bc9a-07bdfefacab4" />


### Result
Thus, a spring Boot application that performs CRUD (Create, Read, Update, Delete) operations on a Student entity using Spring Data JPA (Hibernate) has been created and executed successfully.
